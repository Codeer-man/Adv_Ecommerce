...
function DrawerSection({ title, item }: { title: string; item: NavItem[] }) {
  return (
    ...
    <div className={mobileWrap}>
      ...
      <Sheet>
        <SheetTrigger asChild>
          <Button size={"icon"} variant={"ghost"} className={menuButton}>
        ...
        <SheetContent side="left" className={sheetContent}>
          ...
          <Separator />
          <DrawerSection title="Collection" item={[collectionsPage]} />

          <Separator />
          <DrawerSection title="Account" item={mobileAccountItem} />
        </SheetContent>
      </Sheet>
    </div>
  );
